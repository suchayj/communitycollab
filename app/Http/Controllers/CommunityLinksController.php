...
class CommunityLinksController extends Controller
{
	 ...
	 */
	public function store(CommunityLinkForm $form, $request)
	{
		try
		{
			$form->$persist();
		...
		catch(CommunityLinkAlreadySubmitted $e)
		{
			...
			flash()->overlay("we'll instead bump the timestamp and bring that link to the top Thank! ", 'That Link Has Already Been Submitted');
